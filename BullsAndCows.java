...
public class BullsAndCows extends javax.swing.JFrame {
    ...
    public BullsAndCows() {
        initComponents();
        easyLevel = new Easy();
        easyLevel.setNumber(false);
        hardLevel = new Hard();
        hardLevel.setNumber(true);
    }
    ...
    private void initComponents() {
        ...
        txtSecretNumber = new javax.swing.JTextField();
        ...
        txtSecretNumber.setEnabled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtSecretNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtAttempts, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblAttempts, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
                        .addGap(37, 37, 37)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void cbLevelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbLevelActionPerformed
        ...
        if(selected.equals("easy"))
        {
            ...
            for(int i = 0; i < 4; i++)
            {
                secrNum = secrNum + easyLevel.getNumberIndex(i);
            }
        }
        else
        {
            for(int i = 0; i < 4; i++)
            {
                secrNum = secrNum + hardLevel.getNumberIndex(i);
            }
        }
        txtSecretNumber.setVisible(false);
        txtSecretNumber.setText(secrNum);
    ...
    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        ...
        if(regularExpression) //проверка брой на цифри
        {
            for(int i = 0; i < 4; i++) 
            {
                for(int j = i + 1; j < 4; j++) 
            ...
            if(unique) // проверка различни цифри
            {
                attempts--;
                attemptsString = String.valueOf(attempts);
                txtAttempts.setText(attemptsString);

                resultString = resultString + guess[0] + guess[1] + guess[2] + guess[3] + " - ";
                ...
                if(selected.equals("easy"))
                {
                    bulls = easyLevel.countBulls(guess);
                    cows = easyLevel.countCows(guess);
                }
                else
                {
                    bulls = hardLevel.countBulls(guess);
                    cows = hardLevel.countCows(guess);
                }
                ...
                {
                    JOptionPane.showMessageDialog(null, "Game over! The number was " + txtSecretNumber.getText() + ".");
                    try 
                    {
                        Thread.sleep(500);
                    }
            ...
            else //при повтарящи се цифри
            {
                resultString = resultString + "Enter a number with unique digits \n";
                txtResults.setText(resultString);
            }
        } 
        else //при нечетирицифрено число
        {
    ...
    public static void main(String args[]) throws IOException{
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BullsAndCows().setVisible(true);
            }
        });
        ...
        try
        {
            File file = new File("C:\\Users\\Velina\\Documents\\Информатика\\11 клас\\BullsAndCows\\src\\bullsandcows\\ResultFile.txt");
            PrintStream fileWriter = new PrintStream("C:\\Users\\Velina\\Documents\\Информатика\\11 клас\\BullsAndCows\\src\\bullsandcows\\ResultFile.txt");
    ...
    private javax.swing.JTextField txtSecretNumber;
